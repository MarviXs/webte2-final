...
Route::prefix('questions')->group(function () {
    ...
    Route::post('/{question_id}/close', [VoteController::class, 'close'])->middleware('auth:api');
    Route::get('/{question_id}/closures', [VoteController::class, 'closures'])->middleware('auth:api');
